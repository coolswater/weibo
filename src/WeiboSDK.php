...
class WeiboSDK {
    ...
    function public_timeline( $page = 1, $count = 50, $base_app = 0 )
    {
        ...
        return $this->get(self::$host.'statuses/public_timeline', $params);//可能是接口的bug不能补全
    }
    ...
    function home_timeline( $page = 1, $count = 50, $since_id = 0, $max_id = 0, $base_app = 0, $feature = 0 )
    {
        ...
        return $this->get(self::$host.'statuses/home_timeline', $params);
    }
    ...
    function user_timeline_by_id( $uid = NULL , $page = 1 , $count = 50 , $since_id = 0, $max_id = 0, $feature = 0, $trim_user = 0, $base_app = 0)
    {
        ...
        return $this->get(self::$host. 'statuses/user_timeline', $params );
    }
    ...
    function timeline_batch_by_name( $screen_name, $page = 1, $count = 50, $feature = 0, $base_app = 0)
    {
        ...
        $params['base_app'] = intval($base_app);
        $params['feature'] = intval($feature);
        return $this->get(self::$host.'statuses/timeline_batch', $params);
    }
    ...
    function repost_timeline( $sid, $page = 1, $count = 50, $since_id = 0, $max_id = 0, $filter_by_author = 0 )
    {
        ...
        return $this->request_with_pager( self::$host.'statuses/repost_timeline', $page, $count, $params );
    }
    ...
    function repost_by_me( $page = 1, $count = 50, $since_id = 0, $max_id = 0 )
    {
        ...
        return $this->request_with_pager(self::$host.'statuses/repost_by_me', $page, $count, $params );
    }
    ...
    function mentions( $page = 1, $count = 50, $since_id = 0, $max_id = 0, $filter_by_author = 0, $filter_by_source = 0, $filter_by_type = 0 )
    {
        ...
        return $this->request_with_pager( self::$host.'statuses/mentions', $page, $count, $params );
    }
    ...
    function show_status( $id )
    {
        ...
        $params = array();
        $params['id'] = $id;
        return $this->get(self::$host .'statuses/show', $params);
    }
    ...
    function show_batch( $ids )
    {
        ...
        return $this->get(self::$host . 'statuses/show_batch', $params);
    }
    ...
    function querymid( $id, $type = 1, $is_batch = 0 )
    {
        ...
        return $this->get( self::$host . 'statuses/querymid',  $params);
    }
    ...
    function queryid( $mid, $type = 1, $is_batch = 0, $inbox = 0, $isBase62 = 0)
    {
        ...
        return $this->get(self::$host . 'statuses/queryid', $params);
    }
    ...
    function repost_daily( $count = 20, $base_app = 0)
    {
        ...
        $params['count'] = intval($count);
        $params['base_app'] = intval($base_app);
        return $this->get(self::$host . 'statuses/hot/repost_daily',  $params);
    }
    ...
    function repost_weekly( $count = 20,  $base_app = 0)
    {
        ...
        $params['count'] = intval($count);
        $params['base_app'] = intval($base_app);
        return $this->get(self::$host .  'statuses/hot/repost_weekly',  $params);
    }
    ...
    function comments_daily( $count = 20,  $base_app = 0)
    {
        ...
        $params['count'] = intval($count);
        $params['base_app'] = intval($base_app);
        return $this->get(self::$host .  'statuses/hot/comments_daily',  $params);
    }
    ...
    function comments_weekly( $count = 20, $base_app = 0)
    {
        ...
        $params['count'] = intval($count);
        $params['base_app'] = intval($base_app);
        return $this->get( self::$host . 'statuses/hot/comments_weekly', $params);
    }
    ...
    function repost( $sid, $text = NULL, $is_comment = 0 )
    {
        ...
        return $this->post( self::$host . 'statuses/repost', $params  );
    }
    ...
    function destroy( $id )
    {
        ...
        $params = array();
        $params['id'] = $id;
        return $this->post( self::$host . 'statuses/destroy',  $params );
    }
    ...
    function update( $status, $lat = NULL, $long = NULL, $annotations = NULL, $visible=0 )
    {
        ...
        return $this->post(self::$host .  'statuses/update', $params );
    }
    ...
    function upload( $status, $pic_path, $lat = NULL, $long = NULL, $visible=0 )
    {
        ...
        return $this->post(self::$host .  'statuses/upload', $params, true );
    }
    ...
    function share($status, $pic = false, $rip = false)
    {
        ...
        return $this->post(self::$host . 'statuses/share', $params, $with_media);
    }
    ...
    function upload_url_text( $status,  $url , $visible=0, $list_id=NULL, $pic_id=NULL, $lat = NULL, $long=NULL, $annotations=NULL)
    {
        ...
        return $this->post(self::$host .  'statuses/upload_url_text', $params, true );
    }
    ...
    function emotions( $type = "face", $language = "cnname" )
    {
        ...
        return $this->get(self::$host .  'emotions', $params );
    }
    ...
    function get_comments_by_sid( $sid, $page = 1, $count = 50, $since_id = 0, $max_id = 0, $filter_by_author = 0 )
    {
        ...
        $params['page'] = $page;
        $params['filter_by_author'] = $filter_by_author;
        return $this->get(self::$host .  'comments/show',  $params );
    }
    ...
    function comments_by_me( $page = 1 , $count = 50, $since_id = 0, $max_id = 0,  $filter_by_source = 0 )
    {
        ...
        $params['page'] = $page;
        $params['filter_by_source'] = $filter_by_source;
        return $this->get(self::$host .  'comments/by_me', $params );
    }
    ...
    function comments_to_me( $page = 1 , $count = 50, $since_id = 0, $max_id = 0, $filter_by_author = 0, $filter_by_source = 0)
    {
        ...
        $params['filter_by_author'] = $filter_by_author;
        $params['filter_by_source'] = $filter_by_source;
        return $this->get(self::$host .  'comments/to_me', $params );
    }
    ...
    function comments_mentions( $page = 1, $count = 50, $since_id = 0, $max_id = 0, $filter_by_author = 0, $filter_by_source = 0)
    {
        ...
        $params['filter_by_author'] = $filter_by_author;
        $params['filter_by_source'] = $filter_by_source;
        return $this->get( self::$host . 'comments/mentions', $params );
    }
    ...
    function comments_show_batch( $cids )
    {
        ...
        return $this->get( self::$host . 'comments/show_batch', $params );
    }
    ...
    function send_comment( $id , $comment , $comment_ori = 0)
    {
        ...
        return $this->post( self::$host . 'comments/create', $params );
    }
    ...
    function comment_destroy( $cid )
    {
        $params = array();
        $params['cid'] = $cid;
        return $this->post( self::$host . 'comments/destroy', $params);
    }
    ...
    function comment_destroy_batch( $ids )
    {
        ...
        return $this->post( self::$host . 'comments/destroy_batch', $params);
    }
    ...
    function reply( $sid, $text, $cid, $without_mention = 0, $comment_ori = 0 )
    {
        ...
        return $this->post( self::$host . 'comments/reply', $params );
    ...
    function show_user_by_name( $screen_name )
    {
        ...
        return $this->get( self::$host . 'users/show', $params );
    }
    ...
    function domain_show( $domain )
    {
        ...
        return $this->get( self::$host . 'users/domain_show', $params );
    }
    ...
    function users_show_batch_by_id( $uids )
    {
        ...
        return $this->get( self::$host . 'users/show_batch', $params );
    }
    ...
    function friends_by_id( $uid, $cursor = 0, $count = 50 )
    {
        ...
        return $this->get( self::$host . 'friendships/friends', $params );
    }
    ...
    function friends_in_common( $uid, $suid = NULL, $page = 1, $count = 50 )
    {
        ...
        $params['count'] = $count;
        $params['page'] = $page;
        return $this->get( self::$host . 'friendships/friends/in_common', $params  );
    }
    ...
    function bilateral( $uid, $page = 1, $count = 50, $sort = 0 )
    {
        ...
        $params['page'] = $page;
        $params['sort'] = $sort;
        return $this->get( self::$host . 'friendships/friends/bilateral', $params  );
    }
    ...
    function bilateral_ids( $uid, $page = 1, $count = 50, $sort = 0)
    {
        ...
        $params['page'] = $page;
        $params['sort'] = $sort;
        return $this->get( self::$host . 'friendships/friends/bilateral/ids',  $params  );
    }
    ...
    function friends_ids_by_id( $uid, $cursor = 0, $count = 500 )
    {
        ...
        $params['cursor'] = $cursor;
        $params['count'] = $count;
        return $this->get( self::$host . 'friendships/friends/ids', $params );
    }
    ...
    function friends_remark_batch( $uids )
    {
        ...
        return $this->get( self::$host . 'friendships/friends/remark_batch', $params  );
    }
    ...
    function followers_by_id( $uid , $cursor = 0 , $count = 50)
    {
        ...
        $params['count'] = $count;
        $params['cursor'] = $cursor;
        return $this->get( self::$host . 'friendships/followers', $params  );
    }
    ...
    function followers_ids_by_id( $uid, $cursor = 0 , $count = 50 )
    {
        ...
        $params['count'] = $count;
        $params['cursor'] = $cursor;
        return $this->get( self::$host . 'friendships/followers/ids', $params  );
    }
    ...
    function followers_active( $uid,  $count = 20)
    {
        ...
        $param['uid'] = $uid;
        $param['count'] = $count;
        return $this->get( self::$host . 'friendships/followers/active', $param);
    }
    ...
    function friends_chain_followers( $uid, $page = 1, $count = 50 )
    {
        ...
        $params['count'] = $count;
        $params['page'] = $page;
        return $this->get( self::$host . 'friendships/friends_chain/followers',  $params );
    }
    ...
    function is_followed_by_id( $target_id, $source_id = NULL )
    {
        ...
        return $this->get( self::$host . 'friendships/show', $params );
    }
    ...
    function follow_by_id( $uid )
    {
        ...
        $this->id_format($uid);
        $params['uid'] = $uid;
        return $this->post( self::$host . 'friendships/create', $params );
    }
    ...
    function follow_create_batch( $uids )
    {
        ...
        return $this->post( self::$host . 'friendships/create_batch', $params);
    }
    ...
    function unfollow_by_id( $uid )
    {
        ...
        $this->id_format($uid);
        $params['uid'] = $uid;
        return $this->post( self::$host . 'friendships/destroy', $params);
    }
    ...
    function update_remark( $uid, $remark )
    {
        ...
        return $this->post( self::$host . 'friendships/remark/update', $params);
    }
    ...
    function dm_user_list( $count = 20, $cursor = 0)
    {
        ...
        $params['count'] = $count;
        $params['cursor'] = $cursor;
        return $this->get( self::$host . 'direct_messages/user_list', $params );
    }
    ...
    function dm_conversation( $uid, $page = 1, $count = 50, $since_id = 0, $max_id = 0)
    {
        ...
        $params['count'] = $count;
        $params['page'] = $page;
        return $this->get( self::$host . 'direct_messages/conversation', $params );
    }
    ...
    function dm_show_batch( $dmids )
    {
        ...
        return $this->get( self::$host . 'direct_messages/show_batch',  $params );
    }
    ...
    function send_dm_by_id( $uid, $text, $id = NULL )
    {
        ...
        return $this->post( self::$host . 'direct_messages/new', $params );
    }
    ...
    function delete_dm( $did )
    {
        ...
        $params = array();
        $params['id'] = $did;
        return $this->post( self::$host . 'direct_messages/destroy', $params);
    }
    ...
    function delete_dms( $dids )
    {
        ...
        return $this->post( self::$host . 'direct_messages/destroy_batch', $params);
    }
    ...
    function account_profile_basic( $uid = NULL  )
    {
        ...
        return $this->get( self::$host . 'account/profile/basic', $params );
    }
    ...
    function account_education( $uid = NULL )
    {
        ...
        return $this->get( self::$host . 'account/profile/education', $params );
    }
    ...
    function account_education_batch( $uids  )
    {
        ...
        return $this->get( self::$host . 'account/profile/education_batch', $params );
    }
    ...
    function account_career( $uid = NULL )
    {
        ...
        return $this->get( self::$host . 'account/profile/career', $params );
    }
    ...
    function account_career_batch( $uids )
    {
        ...
        return $this->get( self::$host . 'account/profile/career_batch', $params );
    }
    ...
    function school_list( $query )
    {
        ...
        return $this->get( self::$host . 'account/profile/school_list', $params );
    }
    ...
    {
        return $this->get( self::$host . 'account/rate_limit_status' );
    }
    ...
    function get_uid()
    {
        return $this->get( self::$host . 'account/get_uid' );
    }
    ...
    {
        return $this->post( self::$host . 'account/profile/basic_update',  $profile);
    }
    ...
    {
        return $this->post( self::$host . 'account/profile/edu_update',  $edu_update);
    }
    ...
    function edu_destroy( $id )
    {
        ...
        $params = array();
        $params['id'] = $id;
        return $this->post( self::$host . 'account/profile/edu_destroy', $params);
    }
    ...
    {
        return $this->post( self::$host . 'account/profile/car_update', $car_update);
    }
    ...
    function car_destroy( $id )
    {
        ...
        $params = array();
        $params['id'] = $id;
        return $this->post( self::$host . 'account/profile/car_destroy', $params);
    }
    ...
    function update_profile_image( $image_path )
    {
        ...
        return $this->post( self::$host . 'account/avatar/upload', $params, true);
    }
    ...
    {
        return $this->post( self::$host . 'account/update_privacy', $privacy_settings);
    }
    ...
    function get_favorites( $page = 1, $count = 50 )
    {
        ...
        return $this->get( self::$host . 'favorites', $params );
    }
    ...
    function favorites_show( $id )
    {
        ...
        $this->id_format($id);
        $params['id'] = $id;
        return $this->get( self::$host . 'favorites/show', $params );
    }
    ...
    function favorites_by_tags( $tid, $page = 1, $count = 50)
    {
        ...
        $params['count'] = $count;
        $params['page'] = $page;
        return $this->get( self::$host . 'favorites/by_tags', $params );
    }
    ...
    function favorites_tags( $page = 1, $count = 50)
    {
        ...
        $params['count'] = $count;
        $params['page'] = $page;
        return $this->get( self::$host . 'favorites/tags', $params );
    }
    ...
    function add_to_favorites( $sid )
    {
        ...
        return $this->post( self::$host . 'favorites/create', $params );
    }
    ...
    function remove_from_favorites( $id )
    {
        ...
        $params = array();
        $params['id'] = $id;
        return $this->post( self::$host . 'favorites/destroy', $params);
    }
    ...
    function remove_from_favorites_batch( $fids )
    {
        ...
        return $this->post( self::$host . 'favorites/destroy_batch', $params);
    }
    ...
    function favorites_tags_update( $id,  $tags )
    {
        ...
        return $this->post( self::$host . 'favorites/tags/update', $params );
    }
    ...
    function favorites_update_batch( $tid, $tag )
    {
        ...
        $params['tid'] = $tid;
        $params['tag'] = $tag;
        return $this->post( self::$host . 'favorites/tags/update_batch', $params);
    }
    ...
    function favorites_tags_destroy_batch( $tid )
    {
        $params = array();
        $params['tid'] = $tid;
        return $this->post( self::$host . 'favorites/tags/destroy_batch', $params);
    }
    ...
    function get_trends( $uid = NULL, $page = 1, $count = 10 )
    {
        ...
        $params['page'] = $page;
        $params['count'] = $count;
        return $this->get( self::$host . 'trends', $params );
    }
    ...
    function trends_is_follow( $trend_name )
    {
        ...
        return $this->get( self::$host . 'trends/is_follow', $params );
    }
    ...
    function hourly_trends( $base_app = 0 )
    {
        ...
        return $this->get( self::$host . 'trends/hourly', $params );
    }
    ...
    function daily_trends( $base_app = 0 )
    {
        ...
        return $this->get( self::$host . 'trends/daily', $params );
    }
    ...
    function weekly_trends( $base_app = 0 )
    {
        ...
        return $this->get( self::$host . 'trends/weekly', $params );
    }
    ...
    function follow_trends( $trend_name )
    {
        $params = array();
        $params['trend_name'] = $trend_name;
        return $this->post( self::$host . 'trends/follow', $params );
    }
    ...
    function unfollow_trends( $tid )
    {
        ...
        return $this->post( self::$host . 'trends/destroy', $params );
    }
    ...
    function get_tags( $uid = NULL, $page = 1, $count = 20 )
    {
        ...
        $params['page'] = $page;
        $params['count'] = $count;
        return $this->get( self::$host . 'tags', $params );
    }
    ...
    function get_tags_batch( $uids )
    {
        ...
        return $this->get( self::$host . 'tags/tags_batch', $params );
    }
    ...
    function get_suggest_tags( $count = 10)
    {
        $params = array();
        $params['count'] = intval($count);
        return $this->get( self::$host . 'tags/suggestions', $params );
    }
    ...
    function add_tags( $tags )
    {
        ...
        return $this->post( self::$host . 'tags/create', $params);
    }
    ...
    function delete_tag( $tag_id )
    {
        ...
        return $this->post( self::$host . 'tags/destroy', $params );
    }
    ...
    function delete_tags( $ids )
    {
        ...
        return $this->post( self::$host . 'tags/destroy_batch', $params );
    }
    ...
    function verify_nickname( $nickname )
    {
        ...
        return $this->get( self::$host . 'register/verify_nickname', $params );
    }
    ...
    function search_users( $q,  $count = 10 )
    {
        ...
        $params['q'] = $q;
        $params['count'] = $count;
        return $this->get( self::$host . 'search/suggestions/users',  $params );
    }
    ...
    function search_statuses( $q,  $count = 10)
    {
        ...
        $params['q'] = $q;
        $params['count'] = $count;
        return $this->get( self::$host . 'search/suggestions/statuses', $params );
    }
    ...
    function search_schools( $q,  $count = 10,  $type = 1)
    {
        ...
        $params['count'] = $count;
        $params['type'] = $type;
        return $this->get( self::$host . 'search/suggestions/schools', $params );
    }
    ...
    function search_companies( $q, $count = 10)
    {
        ...
        $params['q'] = $q;
        $params['count'] = $count;
        return $this->get( self::$host . 'search/suggestions/companies', $params );
    }
    ...
    function search_at_users( $q, $count = 10, $type=0, $range = 2)
    {
        ...
        $params['type'] = $type;
        $params['range'] = $range;
        return $this->get( self::$host . 'search/suggestions/at_users', $params );
    }
    ...
    {
        return $this->get( self::$host . 'search/statuses', $query );
    }
    ...
    {
        return $this->get( self::$host . 'search/users', $query );
    }
    ...
    function hot_users( $category = "default" )
    {
        ...
        return $this->get( self::$host . 'suggestions/users/hot', $params );
    }
    ...
    function suggestions_may_interested( $page = 1, $count = 10 )
    {
        ...
        $params['page'] = $page;
        $params['count'] = $count;
        return $this->get( self::$host . 'suggestions/users/may_interested', $params);
    }
    ...
    function suggestions_users_by_status( $content, $num = 10 )
    {
        ...
        $params['num'] = $num;
        return $this->get( self::$host . 'suggestions/users/by_status', $params);
    }
    ...
    function hot_favorites( $page = 1, $count = 20 )
    {
        ...
        $params['count'] = $count;
        $params['page'] = $page;
        return $this->get( self::$host . 'suggestions/favorites/hot', $params);
    }
    ...
    function put_users_not_interested( $uid )
    {
        $params = array();
        $params['uid'] = $uid;
        return $this->post( self::$host . 'suggestions/users/not_interested', $params);
    }
